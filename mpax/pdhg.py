...
class PDHG(raPDHG):
    ...
    def take_step(
        ...
        next_primal_solution = (
            solver_state.current_primal_solution + 1 * delta_primal
            
        )
        next_primal_product = (
            solver_state.current_primal_product + 1 * delta_primal_product
        )
        next_dual_solution = (
            solver_state.current_dual_solution + 1 * delta_dual
        )
